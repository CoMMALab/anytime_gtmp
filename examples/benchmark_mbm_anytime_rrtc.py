...
def main(cfg: DictConfig):
    ...
    # Create VAMP-based cost function with RRTC validation
    # validation_method='rrtc' uses RRTConnect for thorough connectivity checking
    # n_jobs: -1 = all CPUs, -2 = all but one, 1 = serial
    rrtc_max_iterations = cfg.get('rrtc_max_iterations', 10)
